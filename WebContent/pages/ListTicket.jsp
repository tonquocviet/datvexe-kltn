...
<%@ include file="/pages/partion/HeaderCustomer.jsp"%>
			...
			<div class="row header-row">
				<div class="col-md-6 hidden-sm hidden-xs">
					<h1 class="title-text-route">
						...
						<%-- <bean:define id="num" name="searchTicketForm" property="num"></bean:define>
						So day ${num}
						<bean:write name="searchTicketForm" property="num" format="0" /> --%>
						<span class="hidden-xs hidden-sm">Vé xe từ</span> ${noiDi} đến ${noiDen}
					</h1>
				</div>
				<div class="col-md-6 hidden-sm hidden-xs">
					<h6
			...
			<form class="form-inline" id="searchForm" method="post" action="${pageContext.request.contextPath}/searchTicket.do">
				...
				<div class="form-group">
					<span class="ui-helper-hidden-accessible" role="status"
						...
						autocomplete="off" required /> <input id="start-point-type"
				...
				<div class="form-group">
					<span class="ui-helper-hidden-accessible" role="status"
						...
						autocomplete="off" required /> <input id="stop-point-type"
		...
		<div id="replaceDiv">
			<div id="searchResults">
				...
				<ul class="result-list" style="margin: 0px;">
					...
					<%
								ArrayList<ResultChuyenSearch> listRsChuyenSearch = (ArrayList<ResultChuyenSearch>) request.getAttribute("listRsChuyenSearch");
								if(listRsChuyenSearch.size() > 0) {
									for(ResultChuyenSearch rsChuyenSearch : listRsChuyenSearch) {
							%>
					<li class="result-item col-12 col-md-12 col-xs-12"
						...
						<div class="container">
							...
							<div class="hidden-xs">
								...
								<div class="text-right pr0 col-md-3 col-sm-3 col-xs-2 col-lg-2">
									...
									<%
								    	...
								    	String gia1 = df.format(rsChuyenSearch.getGiaVe());
								    	String gia="";
								    	int dem=1;
									...
									%>
									<p style="margin: 0px;">
				                        <button class="no-ticket btn-sold-out-lg rounded-4 w100 btn-vxr-gray-lg" type="button">Hết vé</button>
				                    </p>
				                    <%}%>
								</div>
									...
									<div class="row">
										<div class="col-xs-7">
											<div class="star-mobile">
												...
												<span class="totalHours">(dự kiến <%=rsChuyenSearch.getTgdc()%>h)</span>
											</div>
										</div>
							...
							<p style="color: blue;font-weight: bold;visibility: hidden;">Tên xe: <%=rsChuyenSearch.getXe().getTenXe()%></p>
							<p style="font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tên xe: <span style="color:#236ca8;"><%=rsChuyenSearch.getXe().getTenXe()%></span>	-	Biển số: <span style="color: #236ca8;"><%=rsChuyenSearch.getXe().getBienSo()%></span></p>
						</div>
					</li>
					<% 
									}} else {
					%>
					<p style="color: red;text-align: center;margin: auto;font-size: 20px;margin-top: 10px">Không có chuyến cần tìm!</p>
					<%}%>
				</ul>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-6 border-note right-detail">
							<h2 class="mt10 text-center title-road-backlink mb0">Thông
								tin tuyến đường Đà Nẵng Hồ Chí Minh</h2>

							<ul class="list-detail-route">
								<li>
									<p class="col-md-6 col-sm-6 text-left">Chiều dài tuyến
										đường :</p>
								...
								<li>
									<p class="col-md-6 col-sm-6 text-left">Thời gian di chuyển
										:</p>
									<p class="col-md-6 text-right">
										<b>18 giờ</b>
									</p>
								...
								<li style="border: 0px currentColor;">
						...
						<div class="col-md-6 col-sm-6 border-note right-detail"
							...
							<h2 class="mt10 text-center title-road-backlink mb0">
								<span>Đặt vé xe khách các hãng xe từ Đà Nẵng đến Hồ Chí
									Minh</span>
							</h2>
							...
							<table class="table seo-table">
								...
								<tbody>
									<tr>
										<td height="30"><p class="text-left">Khánh Nhân</p></td>
										<td height="30"><p>
												1.000.000 <small class="unit-price-small"
													style="vertical-align: top;">đ</small>
											</p></td>
										<td height="30"><p class="text-left">11h30</p></td>
									</tr>
									<tr>
										<td height="30"><p class="text-left">Phúc Thuận Thảo</p>
										</td>
										<td height="30"><p>
												590.000 <small class="unit-price-small"
													style="vertical-align: top;">đ</small>
											</p></td>
										<td height="30"><p class="text-left">17h30</p></td>
									</tr>
									<tr>
										<td height="30"><p class="text-left">Cẩm Vân</p></td>
										<td height="30"><p>
												400.000 <small class="unit-price-small"
													style="vertical-align: top;">đ</small>
											</p></td>
										<td height="30"><p class="text-left">10h00</p></td>
									</tr>
									<tr>
										<td height="30"><p class="text-left">Phương Trang</p></td>
										<td height="30"><p>
												355.000 <small class="unit-price-small"
													style="vertical-align: top;">đ</small>
											</p></td>
										<td height="30"><p class="text-left">10h15</p></td>
									</tr>
								</tbody>
							</table>
	...
	<div class="road-point hidden-xs" style="position:fixed;bottom:0;">
